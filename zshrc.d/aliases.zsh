...
# alias update='sudo apt update && sudo apt upgrade -y' # <-- Actualizar todo el sistema (APT)
# alias update='sudo dnf update -y' # <-- Actualizar todo el sistema (DNF)
...
# alias lg='lazygit'                    # <-- Uso rápido y acortado de 'lazy' de git
alias py='python3'                      # <-- Uso rápido/acortado para Python 3
...
alias gc='git commit'          # <-- Hacer commit con mensaje
